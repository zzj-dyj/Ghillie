...
parser.add_argument('--save', type=str, default='EXP/Train_LMN/', help='location of the data corpus')
...
def main():
    ...
    model = Network(args.batch_size, args.M)
